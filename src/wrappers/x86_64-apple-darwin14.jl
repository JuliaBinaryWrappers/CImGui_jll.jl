# Autogenerated wrapper script for CImGui_jll for x86_64-apple-darwin14
export compile_commands, libcimgui_helper, libcimgui, libimgui
...
const libcimgui_helper_splitpath = ["lib", "libcimgui_helper.dylib"]
...
const libcimgui_helper = "@rpath/libcimgui_helper.dylib"


# Relative path to `libcimgui`
const libcimgui_splitpath = ["lib", "libcimgui.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libcimgui = "@rpath/libcimgui.dylib"


# Relative path to `libimgui`
const libimgui_splitpath = ["lib", "libimgui-cpp.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libimgui = "@rpath/libimgui-cpp.dylib"
